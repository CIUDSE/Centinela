...
def iniciar_luces_rover():
    IP_ROVER = "127.0.0.1" if SIMULACION else "0.0.0.0"# En simulación escucha de forma interna, sino escucha en toda la red
    PUERTO = 5006  
    ...
    print(f"SISTEMA DE LUCES (MODO SIMULACION: {SIMULACION})")
