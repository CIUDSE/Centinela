...
{
  telemetryData.rotX = RAW_gyroX / 131.0;
  telemetryData.rotY = RAW_gyroY / 131.0; 
  telemetryData.rotZ = RAW_gyroZ / 131.0;
}

void processAccelData()
{
  telemetryData.accelX = (RAW_accelX / 16384.0)*9.80665;
  telemetryData.accelY = (RAW_accelY / 16384.0)*9.80665; 
  telemetryData.accelZ = (RAW_accelZ / 16384.0)*9.80665;
}